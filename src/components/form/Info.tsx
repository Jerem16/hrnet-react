...
/**
 * Interface pour les props du composant IcoInfoSvg
 * @param {string} [className] - Classe CSS optionnelle pour personnaliser le style du composant
 */
...
/**
 * Composant IcoInfoSvg
 * Affiche une icône d'information sous forme de SVG.
 *
 * @param {IcoInfoSvgProps} props - Les propriétés du composant
 */
    ...
    return (
        <span className={`${className}`}>
            <svg
                ...
                viewBox="0 0 540 540"
                fill="#fff" // Définit la couleur de remplissage à blanc
            >
                {/* Définition du tracé de l'icône */}
...
// Utilisation de React.memo pour optimiser les performances en évitant les rendus inutiles
